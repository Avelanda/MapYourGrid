...
5. [Wikidata QID Generator](https://github.com/open-energy-transition/wikidata_qid_generator)
6. [osmose-per-country](https://github.com/open-energy-transition/osmose_per_country)
7. [gem-per-country](https://github.com/open-energy-transition/gem_per_country)
8. [KPI Tracker tools](https://github.com/open-energy-transition/KPI-OSM)
9. [osm-power-grid-map-analysis](https://github.com/ben10dynartio/osm-power-grid-map-analysis)
10. [ValidateMyGrid](https://github.com/open-energy-transition/validate-my-grid)
11. [OSM Grid Health Score](https://github.com/ben10dynartio/apps_mapyourgrid)
